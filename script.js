 ...
 *    UP_ARROW, DOWN_ARROW, LEFT_ARROW, RIGHT_ARROW, ml5, createCapture, VIDEO, 
 *    classifyVideo, gotResults, image, textSize
 */

let video, classifier, flippedVideo;

let label="";
let imageModelURL = 'https://teachablemachine.withgoogle.com/models/GMoOuu4oR/';
...
let gameIsOver, backgroundColor, playerSnake, currentApple, 
    score,fRate, timer;
